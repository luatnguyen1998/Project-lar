...
@section('main')
					...
					<div id="wrap-inner">
						<div id="product-info">
							...
							<div class="row">
								...
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">{{number_format($product->prod_price,'0','.','.')}} VNĐ</span></p>
									<p>Bảo hành: {{$product->prod_warranty}}</p> 
									<p>Phụ kiện: {{$product->prod_assesories}}</p>
						...
						<div id="comment-list">
							@if($com_list)
							@foreach($com_list as $item)
							<ul>
								<li class="com-title">
									{{$item->com_name}}
									<br>
									<span>{{date('d/m/Y H:i:s',strtotime($com->created_at))}}</span>	
								</li>
